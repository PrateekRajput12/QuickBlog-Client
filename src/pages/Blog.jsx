            ...
            <div className='mt-14 mb-10 max-w-3xl mx-auto'>
                ...
                <div className='flex flex-col gap-4'>
                    {comments.map((item, index) => (
                        ...
                        <div key={index} className='relative bg-primary/2 border border-primary/5 max-w-xl p-4 rounded text-gray-600'>
                            <div className='mb-2b] gap-2 flex items-center'>
                ...
                <div className='max-w-3xl mx-auto'>
                    ...
                    <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
                        <input onChange={(e) => setName(e.target.value)} value={name} type='text' placeholder='Name' required className='w-full p-2 border-gray-300 rounded outline-none' />
                ...
                <div>
                    ...
                    <div className='flex'>
                        <img src={assets.facebook_icon} alt='fb' width={50} />
