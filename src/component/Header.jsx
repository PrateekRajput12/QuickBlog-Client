    ...
    return (
        <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
            <div className='text-center mt-20 mb-8'>
                ...
                <p className='my-6 sm:my-8 max-w-2xl mx-auto max-sm:text-xs text-gray-700'>
                    This is your space to think out loud, to share whjat matters, and top write without filters, Whether it's one word or a thousand, your story start right here.

                </p>
                <form className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden'>

                    <input type='text' placeholder='Search for blogs' required className='w-full pl-4 outline-none' />
                    <button type='submit' className='bg-primary text-white px-8 py-2 m-1.5 rounded-2xl hover:scale-105 transition-all cursor-pointer'>Search</button>
                </form>
            </div>
